...
//tudo que eu tiver o /api são as rotas que eu uso na API, o que não tiver é o que eu testo na web normalmente,
//no navegador, pelo thunder client

@RestController
@RequestMapping("/api/books") //isso responde pela rota /books
public class APIBookController { //O prefixo API serve para o usuário que vai consumir o controller da API
